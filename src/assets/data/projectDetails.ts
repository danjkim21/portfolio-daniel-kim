...
const projectDetails: ProjectDetailsInterface[] = [
	{
		...
		liveLink: new URL('https://ardb.vercel.app/'),
	...
	},
	{
		...
		githubLink: new URL('https://github.com/danjkim21/outpost-app'),
		liveLink: new URL('https://outpost.cyclic.app/'),
	...
	},
	{
		...
		githubLink: new URL('https://github.com/danjkim21/bookly-app'),
		liveLink: new URL('https://bookly.cyclic.app/'),
